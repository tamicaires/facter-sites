      ...
      <div className="container px-4 md:px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-8">
            ...
            <p className="text-[#c1ff00] text-sm">CASES DE SUCESSO</p>
          </div>

          <h2 className="text-3xl md:text-5xl font-bold text-white mb-16">
            Confira alguns cases{" "}
            <span className="text-[#c1ff00]">do meu portfólio</span>
          </h2>
          ...
          <div className="grid lg:grid-cols-[300px,1fr] gap-8">
            <div className="space-y-2">
              ...
              <motion.button
                className="w-full text-left px-4 py-3 rounded border border-[#c1ff00] text-[#c1ff00] mt-4 flex items-center justify-between group"
                whileHover={{ x: 4 }}
              >
                ...
                <Card className="bg-zinc-900/50 border-zinc-800 p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-2">
                      <div className="h-1 w-6 bg-[#c1ff00]" />
